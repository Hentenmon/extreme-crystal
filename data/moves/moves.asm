...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100,  2,   0
	...
	move ROAR,         EFFECT_FORCE_SWITCH,        0, NORMAL,       100,  2,   0
	move SING,         EFFECT_SLEEP,               0, NORMAL,        70,  5,   0
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           70,  8,  10
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,       100,  5,   0
	...
	move STRING_SHOT,  EFFECT_SPEED_DOWN,          0, BUG,           95,  3,   0
	...
	move TELEPORT,     EFFECT_TELEPORT,            0, PSYCHIC_TYPE, 100,  1,   0
	...
	move DEFENSE_CURL, EFFECT_DEFENSE_CURL,        0, NORMAL,       100,  3,   0
	move BARRIER,      EFFECT_DEFENSE_UP_2,        0, PSYCHIC_TYPE, 100,  3,   0
	move LIGHT_SCREEN, EFFECT_LIGHT_SCREEN,        0, PSYCHIC_TYPE, 100,  3,   0
	move HAZE,         EFFECT_RESET_STATS,         0, ICE,          100,  3,   0
	move REFLECT,      EFFECT_REFLECT,             0, PSYCHIC_TYPE, 100,  3,   0
	move FOCUS_ENERGY, EFFECT_FOCUS_ENERGY,        0, NORMAL,       100,  3,   0
	...
	move SKY_ATTACK,   EFFECT_RECOIL_HIT,        120, FLYING,       100,  5,   0
	...
	move PSYWAVE,      EFFECT_LEVEL_DAMAGE,        1, CURSE_TYPE,   100, 15,   0
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,       100, 40,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,       100,  2,   0
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        120, WATER,        100, 10,   0
	...
	move STRUGGLE,     EFFECT_NORMAL_HIT,         50, BIRD,         100,  1,   0
	...
	move CONVERSION2,  EFFECT_CONVERSION2,         0, NORMAL,       100,  3,   0
	move AEROBLAST,    EFFECT_TRI_ATTACK,        120, FLYING,       100,  8,  20
	...
	move SCARY_FACE,   EFFECT_SPEED_DOWN_2,        0, NORMAL,       100,  2,   0
	move FAINT_ATTACK, EFFECT_ALWAYS_HIT,         60, DARK,         100, 20,   0
	move SWEET_KISS,   EFFECT_CONFUSE,             0, NORMAL,       100,  1,   0
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  95, WATER,        100, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       100,  1,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      50,  5, 100
	move FORESIGHT,    EFFECT_FORESIGHT,           0, NORMAL,       100,  2,   0
	...
	move RETURN,       EFFECT_NORMAL_HIT,        102, NORMAL,       100, 20,   0
	...
	move MEGAHORN,     EFFECT_NORMAL_HIT,        120, BUG,           90, 10,   0
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       60, DRAGON,       100, 20,  30
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,       100,  1,   0
	move ENCORE,       EFFECT_ENCORE,              0, NORMAL,       100,  2,   0
